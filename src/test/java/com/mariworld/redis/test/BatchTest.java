...
public class BatchTest extends BaseTest{
    ...
    public void regularTest(){
        ...
        RListReactive<Long> list = this.redissonClient.getList("numbers", LongCodec.INSTANCE);
        RSetReactive<Long> set = this.redissonClient.getSet("numbers-set", LongCodec.INSTANCE);
